...
export const metadata: Metadata = {
  title: "Sweet Dreams Cookies - Best Fresh Baked Cookies in Dallas, TX",
  description: "Dallas's premier cookie shop offering fresh-baked artisan cookies daily. From classic chocolate chip to custom decorated cookies, taste the difference quality makes.",
  keywords: "Dallas cookies, fresh baked cookies, custom cookies Dallas, chocolate chip cookies, artisan bakery, Texas cookies",
  metadataBase: new URL("https://sweetdreamscookies.com"),
  alternates: {
    canonical: "https://sweetdreamscookies.com"
  },
  openGraph: {
    title: "Sweet Dreams Cookies - Dallas's Sweetest Cookie Shop",
    description: "Fresh-baked artisan cookies made with premium ingredients. Visit our Dallas bakery for the best cookies in Texas.",
    siteName: "Sweet Dreams Cookies",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32fyUI1AepMVfxIUkQhrdGSZ2DN/uploaded-1763139216356-ie618i6w.jpg",
        alt: "Fresh cookies display at Sweet Dreams Cookies"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "Sweet Dreams Cookies - Dallas's Best Cookie Shop",
    description: "Handcrafted cookies baked fresh daily with premium ingredients. Located in Dallas, Texas.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32fyUI1AepMVfxIUkQhrdGSZ2DN/uploaded-1763139216356-ie618i6w.jpg"]
  },
  robots: {
    index: true,
    follow: true
